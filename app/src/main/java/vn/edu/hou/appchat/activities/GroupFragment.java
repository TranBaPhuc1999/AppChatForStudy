...
public class GroupFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void getListGroup(){
        FirebaseDatabase.getInstance().getReference().child("user/"+ Config.UID+"/group").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case CONTEXT_MENU_DELETE:
                ...
                if(((String)listGroup.get(posGroup).groupInfo.get("admin")).equals(Config.UID)) {
            ...
            case CONTEXT_MENU_EDIT:
                ...
                if(((String)listGroup.get(posGroup1).groupInfo.get("admin")).equals(Config.UID)) {
            ...
            case CONTEXT_MENU_LEAVE:
                ...
                if(((String)listGroup.get(position).groupInfo.get("admin")).equals(Config.UID)) {
    ...
    public void leaveGroup(final Group group){
        FirebaseDatabase.getInstance().getReference().child("group/"+group.id+"/member")
                .orderByValue().equalTo(Config.UID)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.getValue() == null) {
                            ...
                            FirebaseDatabase.getInstance().getReference().child("user").child(Config.UID)
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((RelativeLayout)((ItemGroupViewHolder) holder).txtGroupName.getParent()).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Config.INTENT_KEY_CHAT_ROOM_ID, listGroup.get(position).id);
